...
const PHASES: Phase[] = [
  {
    ...
    tasks: [
      ...
      { label: "NDA template", status: "done" },
      { label: "Calculadora de costos", status: "done" },
      { label: "Blueprint (Capa 1)", status: "done" },
      { label: "Roadmap (Capa 2)", status: "done" },
      { label: "Menús base por plan", status: "done" },
    ],
  },
  {
    ...
    tasks: [
      ...
      { label: "Contactar Benjamín (nutriólogo de Adriana)", status: "active", note: "Candidato real — trabaja independiente, la conoce" },
    ],
  },
  {
