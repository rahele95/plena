...
export default function PitchLuisFer() {
  return (
    <div style={{ maxWidth: "680px", margin: "0 auto", padding: "3rem 1.5rem 6rem" }}>
      ...
      <p style={{ fontFamily: g.sans, fontSize: "11px", letterSpacing: "0.16em", textTransform: "uppercase", color: g.sage, marginBottom: "12px" }}>Para Luis Fernando · NetLab</p>
      ...
      <p style={{ fontFamily: g.sans, fontSize: "15px", lineHeight: 1.8, color: g.ink3, marginBottom: "3rem", maxWidth: "520px" }}>
        Plena nace en GDL. La visión es franquicia. Necesitamos a quien construya la columna vertebral tecnológica y tenga participación en lo que se replica.
      </p>

      <hr style={{ border: "none", borderTop: `0.5px solid ${g.stone}`, marginBottom: "3rem" }} />

      <p style={{ fontFamily: g.sans, fontSize: "11px", letterSpacing: "0.16em", textTransform: "uppercase", color: g.sage, marginBottom: "1rem" }}>El modelo en 3 fases</p>
      <div style={{ display: "flex", flexDirection: "column" as const, gap: "10px", marginBottom: "3rem" }}>
        {[
          { n: "01", t: "GDL · Validación", d: "Plataforma de pedidos, CRM, automatizaciones, pagos. El sistema que hace funcionar la operación." },
          { n: "02", t: "Escala nacional",  d: "Monterrey, CDMX, Puebla. El mismo sistema replicado en nuevas ciudades." },
          { n: "03", t: "Franquicia LATAM", d: "El modelo empaquetado como franquicia tecnológica. Tú tienes el 50% de la IP." },
        ].map((item, i) => (
      ...
      <p style={{ fontFamily: g.sans, fontSize: "11px", letterSpacing: "0.16em", textTransform: "uppercase", color: g.sage, marginBottom: "1rem" }}>Tu compensación</p>
      <div style={{ display: "flex", flexDirection: "column" as const, gap: "10px", marginBottom: "3rem" }}>
        {[
          { label: "Setup plataforma inicial",           value: "$30,000 MXN · al firmar" },
          { label: "Retainer mensual",                   value: "$10,000 MXN / mes · desde mes 3" },
          { label: "Fee pedidos canal digital",          value: "4% por pedido · desde el día 1 online" },
      ...
      <div style={{ background: g.night, borderRadius: "6px", padding: "2rem", marginBottom: "3rem" }}>
        <p style={{ fontFamily: g.sans, fontSize: "11px", letterSpacing: "0.16em", textTransform: "uppercase", color: "rgba(168,196,160,0.7)", marginBottom: "1rem" }}>La proyección real</p>
        <p style={{ fontFamily: g.serif, fontSize: "clamp(1.4rem,2.5vw,1.8rem)", color: "#f5f0e8", lineHeight: 1.3, marginBottom: "8px" }}>
          5 ciudades en 3 años = royalties de $150k–250k MXN / mes
        </p>
        <p style={{ fontFamily: g.sans, fontSize: "13px", color: "rgba(248,250,245,0.5)", margin: 0, lineHeight: 1.7 }}>
          El retainer no es el negocio. El negocio es construir juntos el sistema que se replica. Cada franquicia que abre es ingreso recurrente para NetLab sin trabajo marginal adicional.
        </p>
      </div>
      ...
      <div style={{ padding: "1rem", background: g.ivory, border: `0.5px solid ${g.stone}`, borderRadius: "4px" }}>
        <p style={{ fontFamily: g.sans, fontSize: "13px", color: g.ink3, margin: 0, lineHeight: 1.7 }}>
          El acuerdo de copropiedad IP y la exclusividad de categoría food-tech LATAM se formaliza en contrato antes de revelar arquitectura o datos de operación.
        </p>
      </div>
    </div>
  );
