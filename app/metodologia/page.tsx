          ...
          <div style={wrap}>
            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 16 }}>
              {[
                ...
                { id:"DB4", name:"Inventario e insumos", color: "#7aaa22", fields:[{n:"Ingrediente",t:"Título",u:"Nombre del insumo"},{n:"Proveedor",t:"Relación",u:"Link a base de Proveedores"},{n:"Stock actual",t:"Number",u:"Unidades disponibles"},{n:"Stock mínimo",t:"Number",u:"Alerta cuando baja de este número"},{n:"Precio / kg o unidad",t:"Number",u:"Para calcular costo de recetas"}] },
                ...
                { id:"DB8", name:"Suplementos", color: "#7aaa22", fields:[{n:"Producto",t:"Título",u:"Nombre del suplemento"},{n:"Precio de costo",t:"Number",u:"Lo que Plena paga"},{n:"Precio de venta",t:"Number",u:"Lo que cobra al cliente"},{n:"Margen",t:"Fórmula",u:"Calculado automático"},{n:"Para quién",t:"Multi-select",u:"Plan médico donde aplica"}] },
              ].map(db => (
            ...
            <div style={wrap}>
              ...
              <div style={{ display: "flex", flexDirection: "column" as const, gap: 14 }}>
                {[
                  ...
                  { fase:"Fase 3 — Mes 6-12", title:"Comunidad y educación", icon:"🌱", items:["Colaboración con nutriólogos y médicos GDL — su audiencia es el cliente de Plena","Serie educativa: '¿Qué tienen tus macros esta semana?'","Gimnasios como canal de distribución + contenido","Newsletter mensual: receta gratis + menú del mes + oferta suscriptores","Instagram Broadcast Channel: tips exclusivos y preventa de viajes grupales"] },
                ].map(f => (
